...
window.onload = async function() {
  ...
  window.ethereum.send({ method: 'eth_requestAccounts' }, function (error, accounts) {
    ...
    document.getElementById("backButton").addEventListener("click", function() {window.location = "../Frontend/TradeOffers.html"})
}
...
async function getAllOffers() {
    ...
    for (let i = 0; i < allOffers.length; i++) {
      ...
      //console.log(`asdas` + requesters[i])
    }
